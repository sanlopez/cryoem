...
To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/sanlopez/cryoem) for details.
 ...
 * https://github.com/sanlopez/cryoem/releases
 * https://github.com/sanlopez/cryoem/releases/new
...
Check the build status here: [![Build Status](https://travis-ci.org/sanlopez/cryoem.svg?branch=master)](https://travis-ci.org/sanlopez/cryoem)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/sanlopez](https://travis-ci.org/profile/sanlopez)
